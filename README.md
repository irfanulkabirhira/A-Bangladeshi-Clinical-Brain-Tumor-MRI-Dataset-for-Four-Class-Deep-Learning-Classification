...
> directly to a git repository. This repo hosts the **code**; the dataset itself is
> distributed separately (see [How to Reproduce](#how-to-reproduce) and the release/
> hosting link you add below).
...
If you use BDNeuro-MRI in your research, please cite both this dataset/paper and the
...
@dataset{bdneuro_mri,
  ...
  year         = {2026},
  publisher    = {<Publisher / Repository Host Here>},
  url          = {<Dataset / Paper URL Here>}
}
```

> Replace the placeholders above with your author list, publication venue/DOI, and
> hosting link once finalized.
...
model benchmark. [Add any additional acknowledgements, funding sources, or ethical
approval/IRB statements here.]
